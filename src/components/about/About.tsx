...
const About = () => {
    ...
    return (
        <section id="about" className={`${styles.about} ${globalStyles.container}`}>
            <div className={styles.about__content}>
                <h2 className={styles.about__subtitle}>Hi, I'm Colin</h2>
                <h2 className={styles.about__title}>I am a <strong>Software Engineer</strong></h2>
                <p className={styles.about__description}>A passionate <strong>Backend / Fullstack</strong> web developer,
                    with a focus in
                    building large
                ...
                <ul className={styles.about__list}>
                    <li>
                        <a href="ColinBjorneResume.pdf" download="ColinBjorneResume.pdf" target="_blank">
                            <button className={`${styles.about__resume} ${globalStyles.btn}`}>Resume</button>
                        </a>
                    </li>
                    <li>
                        <a className={styles.about__link} href="https://www.linkedin.com/in/colinbjorne/" target="_blank">
                            <svg className={styles.about__img} xmlns="http://www.w3.org/2000/svg" width="2500" height="2500"
                    ...
                    <li>
                        <a className={styles.about__link} href="https://github.com/cbjorne" target="_blank">
                            <svg className={`${styles.about__img} ${isDark ? globalStyles.invertColors : ''}`} xmlns="http://www.w3.org/2000/svg"
                    ...
                    <li>
                        <a className={styles.about__link} href="https://leetcode.com/u/cbjorne/" target="_blank">
                            <svg className={`${styles.about__img} ${isDark ? globalStyles.invertColors : ''}`} xmlns="http://www.w3.org/2000/svg"
            ...
            <div className={styles.about__img_wrapper}>
                <img className={styles.about__big_img} src="/desk.png" alt="Desk" />
            </div>
        </section>
    );
};
